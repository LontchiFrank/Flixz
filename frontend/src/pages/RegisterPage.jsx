...
import { Mail, Lock, User, Sparkles, Eye, EyeOff, Copy } from "lucide-react";
...
const RegisterPage = () => {
  ...
  const copyPartyLink = () => {
    ...
    toast.success("Link copied! Paste it in Safari or Chrome to sign up.");
  };
  ...
  return (
    <div
      className="min-h-screen bg-[#050505] flex items-center justify-center px-6 py-12"
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="glass rounded-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <label className="text-sm text-[#A1A1AA]">Confirm Password</label>
              <div className="relative">
                <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-[#52525B]" />
                <Input
                  type={showPassword ? "text" : "password"}
