...
const CustomContentPage = () => {
  ...
  const watchContent = (item) => {
    navigate(`/watch/custom/${item.content_id}?custom=true&videoUrl=${encodeURIComponent(BACKEND_URL + item.video_url)}`);
  };
  ...
  return (
    <div className="min-h-screen bg-[#050505] pb-20 md:pb-8" data-testid="custom-content-page">
                ...
                <div>
                  ...
                  {videoPreview ? (
                    ...
                    >
                      ...
                      <p className="text-[#A1A1AA]">Click to select video file</p>
                    </button>
                  )}
                </div>
